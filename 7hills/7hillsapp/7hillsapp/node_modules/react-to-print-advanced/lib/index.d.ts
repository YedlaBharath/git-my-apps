...
export default class ReactToPrint extends React.Component<IReactToPrintProps> {
    ...
    handlePrint: () => void;
    setRef: (ref: any) => void;
    render(): React.ReactElement<ITriggerProps<{}>, string | ((props: any) => React.ReactElement<any, string | any | (new (props: any) => React.Component<any, any, any>)>) | (new (props: any) => React.Component<any, any, any>)>;
}
